          ...
          <ul className="hidden md:flex gap-8 list-none">
            {NAV_LINKS.map((item) => (
              <li key={item.label}>
                <Link
                  href={item.href}
                  className="text-[11px] tracking-[0.14em] uppercase text-[rgb(var(--gp-fg-rgb) / 0.55)] hover:text-[var(--gp-accent)] transition-colors duration-200"
                >
                  {item.label}
                </Link>
              </li>
                ...
                {NAV_LINKS.map((item) => (
                  <li key={item.label}>
                    <Link
                      href={item.href}
                      onClick={() => setMobileOpen(false)}
                      className="block py-3 text-[13px] tracking-[0.14em] uppercase text-[rgb(var(--gp-fg-rgb) / 0.6)] hover:text-[var(--gp-accent)] border-b border-[rgb(var(--gp-fg-rgb) / 0.06)] transition-colors duration-200"
                    >
                      {item.label}
                    </Link>
                  </li>
